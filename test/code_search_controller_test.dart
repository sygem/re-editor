...
void main() {
  group('CodeFindController getter ', () {
    test('`allMatchSelections`', () async {
      {
        final CodeFindController controller =
            CodeFindController(CodeLineEditingController());
        ...
        final CodeFindController controller = CodeFindController(
            ...
            const CodeFindValue(
                option: CodeFindOption(
                    pattern: 'a', caseSensitive: false, regex: false),
                replaceMode: false));
        expect(controller.allMatchSelections, null);
      ...
      }
      {
        ...
        expect(controller.allMatchSelections, const [
          CodeLineSelection(
              baseIndex: 0, baseOffset: 0, extentIndex: 0, extentOffset: 1),
          CodeLineSelection(
              baseIndex: 2, baseOffset: 1, extentIndex: 2, extentOffset: 2)
        ]);
        controller.close();
      }
      {
        ...
        expect(controller.allMatchSelections, const [
          ...
          CodeLineSelection(
              baseIndex: 2, baseOffset: 0, extentIndex: 2, extentOffset: 1),
        ]);
        controller.close();
      }
    });
    ...
    test('`currentMatchSelection`', () async {
      ...
      }
      {
        ...
        await Future.delayed(const Duration(milliseconds: 200));
        expect(
            controller.currentMatchSelection,
  ...
  group('CodeFindController method ', () {
    test('`findMode`', () async {
      {
        final CodeFindController controller =
            CodeFindController(CodeLineEditingController.fromText('abc'));
        ...
        expect(
            ...
            const CodeFindValue(
                option: CodeFindOption(
                    pattern: '', caseSensitive: false, regex: false),
                replaceMode: false));
      }
      {
        ...
        final CodeFindController controller =
            CodeFindController(editingController);
        expect(controller.value, null);
        controller.findMode();
        expect(
            controller.value,
            const CodeFindValue(
                option: CodeFindOption(
                    pattern: 'b', caseSensitive: false, regex: false),
                replaceMode: false,
                searching: true));
        expect(controller.findInputController.text, 'b');
        expect(controller.findInputController.selection,
    ...
    test('`focusOnReplaceInput`', () {
      ...
      expect(controller.replaceInputController.selection,
          const TextSelection(baseOffset: 0, extentOffset: 3));
    });
    ...
    test('`previousMatch & nextMatch`', () async {
      {
        final CodeFindController controller =
            CodeFindController(CodeLineEditingController.fromText('abcabcabc'));
        controller.findMode();
        ...
        expect(
            ...
            CodeFindValue(
                ...
                result: CodeFindResult(
                    ...
                    option: const CodeFindOption(
                        pattern: 'a', caseSensitive: false, regex: false),
                    codeLines: CodeLines.of([const CodeLine('abcabcabc')]),
                    dirty: false)));
    ...
    test('`replaceMatch`', () async {
      {
        final CodeLineEditingController editingController =
            CodeLineEditingController.fromText('abcabcabc');
        final CodeFindController controller =
            CodeFindController(editingController);
        controller.replaceMode();
        controller.findInputController.text = 'a';
        ...
        expect(editingController.codeLines,
            CodeLines.of(const [CodeLine('bbcabcabc')]));
        await Future.delayed(const Duration(milliseconds: 200));
        controller.replaceMatch();
        expect(editingController.codeLines,
            CodeLines.of(const [CodeLine('bbcbbcabc')]));
        await Future.delayed(const Duration(milliseconds: 200));
        controller.replaceMatch();
        expect(editingController.codeLines,
            CodeLines.of(const [CodeLine('bbcbbcbbc')]));
      }
      // replace with same text
      {
        ...
        controller.replaceMatch();
        expect(editingController.codeLines,
            CodeLines.of(const [CodeLine('abcabcabc')]));
        expect(editingController.selection,
        ...
        expect(editingController.codeLines,
            CodeLines.of(const [CodeLine('abcabcabc')]));
        expect(editingController.selection,
            const CodeLineSelection.collapsed(index: 0, offset: 7));
